...
class TestGeometryFunctions(unittest.TestCase):
    ...
    def test_AreaCircle(self):
        ...
        self.assertAlmostEqual(AreaCircle(1e6), math.pi * (1e6) ** 2, places=4)
